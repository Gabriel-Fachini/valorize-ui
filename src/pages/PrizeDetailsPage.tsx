            ...
            <div className="space-y-6">
              <div>
                <div className="mb-3 flex items-start justify-between">
                  <h1 className="text-3xl font-bold text-gray-900 dark:text-white">{prize.title}</h1>
                  {prize.featured && (
              ...
              {prize.preferences && prize.preferences.length > 0 && (
                <div className="rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 p-6 backdrop-blur-xl">
                  <h3 className="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Preferências</h3>
                  <div className="space-y-4">
