  ...
  return (
    <div className="mb-8 space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        >
          <SelectTrigger className="w-[200px] rounded-xl border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 backdrop-blur-xl focus:border-green-500 focus:ring-green-500/20">
        ...
        {hasActiveFilters && (
          <Button
            ...
            variant="outline"
            size="sm"
            className="border-red-200 dark:border-red-500/20 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10 hover:border-red-300 dark:hover:border-red-500/30"
          >
            <i className="ph-bold ph-x-circle mr-2 text-sm" />
            Limpar filtros
          </Button>
        )}
      </div>
      ...
      {hasActiveFilters && (
        <div className="flex flex-wrap items-center gap-2">
          <span className="text-xs font-medium text-gray-600 dark:text-gray-400">Filtros ativos:</span>
          ...
          {filters.category && (
            ...
            >
              <i className="ph-fill ph-tag text-sm"></i>
          ...
          {filters.search && (
            ...
            >
              <i className="ph-fill ph-magnifying-glass text-sm"></i>
              "{filters.search}"
              <i className="ph ph-x text-sm"></i>
            </Badge>
          )}
